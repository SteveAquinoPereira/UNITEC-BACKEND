      ...
      if($accepted){
           ...
           switch($user_type){
            ...
            case 2:
                ...
                ->select('id_subject','subject_name','id_section','section_name')
                ->where('id_user',$id_user)->get();

                return response(['personalData' => $personalData, 'subjectsData' => $subjectsData]);
            ...
            /*
                AQUI VA EL ALGORITMO PARA OBTENER LOS DATOS DE LA PAGINA PRINCIPAL DE LOS ESTUDIANTES
            */
